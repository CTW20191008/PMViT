...
_C.DATA.UNORDER_RATIO = 0.6
_C.DATA.RANDOM_UNORDER = False
_C.DATA.MIN_UNORDER_RATIO = 0.3
_C.DATA.MAX_UNORDER_RATIO = 0.6
_C.DATA.DO_MASK = False
_C.DATA.MASK_PIXEL = 2
_C.DATA.DO_SHUFFLE = True
...
# Model mode: [pretrain, inference, finetune]
_C.MODEL.MODE = 'pretrain'
# Model loss: [L1, L2]
_C.MODEL.LOSS = 'L1'
...
# [PViT]
_C.PRETRAIN = CN()
_C.PRETRAIN.HOLD_FIRST_PATCH = False
_C.PRETRAIN.PATCH_FLIP = True
